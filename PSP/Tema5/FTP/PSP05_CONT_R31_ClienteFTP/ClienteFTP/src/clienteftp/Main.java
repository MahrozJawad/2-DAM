...
public class Main {
  ...
  //URL del servidor
  private static String servidorURL = "192.168.0.100";
  //ruta relativa (en Servidor FTP) de la carpeta que contiene
  //el fichero que vamos a descargar
  private static String rutaFichero = "ftp://192.168.0.100/Descargas/SGE/";
  //nombre del fichero (aunque carece de extensión, se trata de un fichero de
  //texto que puede abrise con el bloc de notas)
  private static String nombreFichero = "calendario-escolar-2019-2020-y-bachillerato.pdf";
  //usuario
  private static String usuario = "alumno";
  //contraseña
  ...
  public static void main(String[] args) {
    try {
      ...
      clienteFTP.connect("192.168.0.100");
