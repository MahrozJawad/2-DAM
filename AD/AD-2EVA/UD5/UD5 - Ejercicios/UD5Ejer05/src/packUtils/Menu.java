...
import static ud5ejer01.UD5Ejer01.BuscarLibrosPorTituloYPaginas;
...
public class Menu {
    ...
    public static void Mostrar() {
        ...
        while (!salir) {
            ...
            System.out.println(Colores.LETRA_BLANCO + "4. buscar libros por titulo y paginas");
