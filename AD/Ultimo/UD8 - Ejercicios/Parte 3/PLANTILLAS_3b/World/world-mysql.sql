...
CREATE DATABASE  IF NOT EXISTS world COLLATE utf8mb4_general_ci;
USE world;
...
CREATE TABLE countrylanguage (
  countrycode char(3) NOT NULL DEFAULT '',
  languagename char(30) NOT NULL DEFAULT '',
  isofficial enum('T','F') NOT NULL DEFAULT 'F',
  percentage float(4,1) NOT NULL DEFAULT '0.0',
  PRIMARY KEY (CountryCode,languagename)
) ENGINE=InnoDB;
...
INSERT INTO `countrylanguage` (`CountryCode`, `Languagename`, `IsOfficial`, `Percentage`) VALUES
('ABW', 'Dutch', 'T', '5.3'),
('ABW', 'English', 'F', '9.5'),
