...
public class GameScreen extends ScreenAdapter {
    ...
    private BackgroundSatge bgStage;
    ...
    public void show() {
        ...
        flappee = new Flappee(textureAtlas);
        flappee.setPosition(WORLD_WIDTH / 4, WORLD_HEIGHT / 2);

        bgStage = new BackgroundSatge(
            WORLD_WIDTH, WORLD_HEIGHT, textureAtlas);
    }
...
//        System.out.println(batch.totalRenderCalls);
    ...
    private void drawScore() {
        ...
        gl.setText(bitmapFont, scoreAsString);
        bitmapFont.draw(batch, scoreAsString, viewport.getWorldWidth() / 2 - gl.width / 2, (4 * viewport.getWorldHeight() / 5) - gl.height / 2);
    }
